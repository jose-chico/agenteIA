...
import { ManualPaymentStatusController } from "@/controllers/services/ManualPaymentStatusController";
...
// --- ROTAS DE PAGAMENTO (manual) ---
router.get("/payments/manual-status", AuthMiddleware, ManualPaymentStatusController);
