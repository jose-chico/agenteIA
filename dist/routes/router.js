...
const AdminLoginController_1 = require("../controllers/auth/AdminLoginController");
...
router.post("/login", LoginController_1.LoginController); // Login de clientes
router.post("/admin/login", AdminLoginController_1.AdminLoginController); // Login de admins
...
router.get("/clientes", auth_1.AuthMiddleware, ListClientesController_1.ListClientesController); // Volta para AuthMiddleware temporariamente
router.delete("/clientes/:id", adminAuth_1.AdminMiddleware, DeleteClienteController_1.DeleteClienteController);
// --- ROTAS DE MENSAGEM ---
...
router.post("/messages/broadcast", auth_1.AuthMiddleware, BroadcastMessageController_1.BroadcastMessageController); // AuthMiddleware temporário
